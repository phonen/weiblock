webpackJsonp([0], [, function(t, e, i) {
	...
	var s = i(61),
		...
		o = n + "qrcode",
		l = function(t) {
			return S(n + "user", t).then(function(t) {
				return t.data
			})
		},
		c = function() {
			return a.a.post(n + "balance").then(function(t) {
				return t.data
			})
		},
		r = function(t) {
		...
		d = function(t) {
			return S(n + "withdraw", t).then(function(t) {
				return t.data
			})
		},
		v = function(t) {
			return S(n + "startgame", t).then(function(t) {
				return t.data
			})
		},
		h = function(t) {
			return S(n + "transfershistory", t).then(function(t) {
				return t.data
			})
		},
		m = function(t) {
			return S(n + "withdrawhistory", t).then(function(t) {
				return t.data
			})
		},
		A = function(t) {
			return S(n + "querymatchhistory", t).then(function(t) {
				return t.data
			})
		},
		p = function(t) {
			return S(n + "rank", t).then(function(t) {
				return t.data
			})
		},
		C = function(t) {
			return S(n + "agency", t).then(function(t) {
				return t.data
			})
		},
		f = function(t) {
		...
		y = function(t) {
			return S(n + "red", t).then(function(t) {
				return t.data
			})
		},
		x = function(t) {
		...
		I = function(t) {
			return S(n + "notice", t).then(function(t) {
				return t.data
			})
		},
		B = function(t) {
		...
		created: function() {
			...
			i.i(s.e)().then(function(e) {
				...
				if (200 === s) {
					...
					t.balance = (n + o).toFixed(2), t.$emit("okfn", a)
				} else console.log(i)
			})
		},
...
default = {
		...
		mounted: function() {
			...
			this.$nextTick(function() {
				t.area = t.$refs.notice, t.area.scrollTop = 0, setTimeout(t.startScroll, 3e3)
			})
		},
		methods: {
			_query: function() {
			...
			startScroll: function() {
				this.init || (this.area.innerHTML += this.area.innerHTML), this.area.scrollTop++, this.time = setInterval(this.scrollUp, 50), this.init = !0
			},
			scrollUp: function() {
...
default = {
		...
		watch: {
			isShow: function(t, e) {
				var i = this;
				console.log(t, e), setTimeout(function() {
					i.show = t
				}, 50)
			}
		}
				...
				if (this.$refs.wrapper) {
					if (this.scroll = new a.a(this.$refs.wrapper, {
						...
						this.scroll.on("scroll", function(i) {
							t.listenScroll && e.$emit("scroll", i), t.pulldown && (i.y > 50 ? t.pulldownTip = {
								text: "松开立即刷新",
								rotate: "icon-rotate",
								status: !0
							} : t.pulldownTip = {
					...
					}), this.pulldown && this.scroll.on("touchend", function(e) {
...
default = {
		...
		methods: {
			pourNum: function(t) {
				this.act = t, this.$emit("parentfn", "1", t)
			},
			downNum: function(t) {
				this.selAct = t, this.$emit("parentfn", "2", t)
			}
		}
	}
}, function(t, e, i) {
		...
		methods: {
			pourNum: function(t) {
				...
				if (t.checked) t.checked = !t.checked;
					...
					this.$set(t, "checked", !0), this.limit++
				}
...
default = {
		...
		methods: {
			pourNum: function(t) {
				this.itemBtnAct = t, this.$emit("parentfn", "2", t)
			}
		}
	}
}, function(t, e, i) {
...
default = {
		...
		methods: {
			query: function(t) {
				...
				"object" == !(void 0 === t ? "undefined" : o()(t)) && (t = {}), t = a()(t, {
					type: s
		...
		methods: {
			...
			timer: function(t) {
				...
				e.timersRes = window.setInterval(function() {
					var i = 0,
						...
						a = 0,
						n = 0;
					t > 0 && (i = Math.floor(t / 86400), s = Math.floor(t / 3600) - 24 * i, a = Math.floor(t / 60) - 24 * i * 60 - 60 * s, n = Math.floor(t) - 24 * i * 60 * 60 - 60 * s * 60 - 60 * a), a <= 9 && (a = "0" + a), n <= 9 && (n = "0" + n), e.minute = a, e.second = n, a <= 0 && n <= 0 && (window.clearInterval(e.timersRes), e.qrcodeExpire = !0), t--
				}, 1e3)
			},
			ajaxQuery: function(t, e) {
				...
				i.i(s.n)(o).then(function(i) {
					var s = (i.msg, i.code);
					i.result;
					if (200 == s) n.payState = !0, window.clearInterval(n.timersRes), n.downCountBox = !1;
					else {
						var o = a;
...
default = {
		...
		created: function() {
			...
			i.i(l.e)().then(function(e) {
				var i = (e.msg, e.code),
					s = e.result;
				if (200 != i) return t.isShowPrompt = !0, void(t.promptMsg = "登录已超时，重刷新页面");
				var a = parseFloat(s.balance),
					n = parseFloat(s.red_packet);
				t.balance = (a + n).toFixed(2), t.userid = s.id, t.querynewusermoney()
			})
		},
		methods: {
			...
			querynewusermoney: function() {
				...
				i.i(l.r)().then(function(e) {
					var i = (e.msg, e.code);
					e.result;
					if (200 == i) t.isShowRedPack = !0, t.createCaptcha();
					else {
			...
			saveVerCode: function(t) {
				this.codeAct = t, this.curVercode = t
			},
			submitRedPack: function() {
				var t = this;
				if (!this.curVercode) return this.isShowPrompt = !0, void(this.promptMsg = "请先选择上方图标");
				var e = {
			...
			promptOkFn: function() {
				this.isShowPrompt = !1, this.isPromptEnd && this.isFristr && (this.isShowPopup = !0, this.isFristr = !1)
			}
		}
	}
}, function(t, e, i) {
...
default = {
		...
		methods: {
			query: function(t) {
				var e = this;
				"object" == !(void 0 === t ? "undefined" : a()(t)) && (t = {}), i.i(r.d)(t).then(function(t) {
					var i = t.msg,
						s = t.code,
						a = t.result;
...
default = {
		...
		mounted: function() {
			this.$refs.listbox.addEventListener("touchmove", function(t) {
				t.stopPropagation()
			})
		}
	}
...
default = {
		...
		created: function() {
			...
			i.i(l.f)().then(function(i) {
				var s = (i.msg, i.code),
					a = i.result;
				if (200 == s) {
					t.isShowLoading = !1, t.userid = a.userid;
		...
		methods: {
			message: function(t) {
				...
				e.className = "lis", e.out = window.setTimeout(function() {
					e.remove()
				}, 3e3), e.innerHTML = t, this.$refs.globalnotice && this.$refs.globalnotice.appendChild(e)
			}
		}
	}
}, function(t, e, i) {
...
default = {
		...
		created: function() {
			this.queryBalanceFun(), this.toggleTyps(this.matchone, 1)
		},
		methods: {
			...
			promptAlert: function(t) {
				this.promptMsg = "最多只能选择 " + t + " 个数", this.isShowPrompt = !0
			},
			callBetFn: function(t, e) {
				...
				case "2":
					...
					break;
				case "3":
					this.curLevel = null, this.curBetNum = e
				}
				this.setPreIncome()
			},
			setPreIncome: function() {
				var t = this.globalOddsNum[this.typeAct];
				null != this.curBetNum && 3 == this.typeAct ? (t = t[this.curBetNum.length], this.preIncome = (t * this.curDownFee / 100).toFixed(2), this.curPoundage = (10 * this.curDownFee / 10).toFixed(2)) : 1 == this.typeAct ? (t = t[this.curLevel], this.preIncome = (t * this.curDownFee / 100).toFixed(2), this.curPoundage = (10 * this.curDownFee / 10).toFixed(2)) : (this.preIncome = "0.00", this.curPoundage = "0.00")
			},
			toggleTyps: function(t, e) {
				this.typeAct = e, localStorage.getItem("type" + e) || (this.isShowRule = !0, localStorage.setItem("type" + e, !0)), this.currentView = t, this.curBetNum = null, this.setPreIncome()
			},
			showdialog: function() {
				this.isShowDialog = !0
			},
			...
			changDownFee: function() {
				this.curDownFee = 10 * parseInt(this.downCountMod), this.setPreIncome()
			},
			setDownCount: function(t) {
				...
				this.curDownFee = 10 * parseInt(this.downCountMod), this.curDownFee = this.curDownFee.toFixed(2), this.setPreIncome()
			},
			submitBet: function() {
				var t = this;
				if (null == this.curBetNum) return this.promptMsg = "请选择吃鸡号码", void(this.isShowPrompt = !0);
				if (!(this.downCountMod > 0 && this.downCountMod <= 20)) return this.promptMsg = "下注数不合法，请重新提交", void(this.isShowPrompt = !0);
				if (3 == this.typeAct && this.curBetNum.length <= 1) return this.promptMsg = "多雷场最少选两个号码", void(this.isShowPrompt = !0);
				var e = {
				...
				this.isShowLoading || (this.isShowLoading = !0, i.i(A.p)(e).then(function(e) {
					...
					var i = e.msg,
						...
						n = e.result;
					if (200 == a) {
						t.queryBalanceFun(), t.matchResult = n.match_result, t.orderOn = n.orderId, t.gameLevel = n.level, t.keyNum = n.keyNum;
						var o = {
							1: "豹子",
							2: "顺子",
							3: "亮号"
						};
						t.luckNum = o[n.luckNum], t.typeAct < 3 ? t.userVal = t.curBetNum : t.userVal = t.curBetNum.split("").join(","), t.oddsNum = n.oddsNum, t.curPoundage = (parseFloat(n.curPoundage) / 100).toFixed(2), 1 == t.matchResult ? t.incomeResult = "+" + t.oddsNum * (10 * t.downCountMod) / 100 : 3 == t.matchResult ? t.incomeResult = "+" + t.oddsNum * (10 * t.downCountMod) / 100 : t.incomeResult = "-" + 10 * t.downCountMod, t.isShowDialog = !0
					} else {
						var l = '<div class="prompt-with"><div class="p-line" style="display: flex"><div class="l-item" style="flex: 2; text-align: right">当前可用余额：</div><div class="r-item" style="flex: 1;text-align: right; color: #f4733b">' + t.balance + '元</div> </div> <div class="p-line"  style="display: flex"> <div class="l-item" style="flex: 2;text-align: right"> 红包(可抵手续费)：</div> <div class="r-item" style="flex: 1;text-align: right">' + t.redPacket + '元</div> </div> <div class="p-line"  style="display: flex"> <div class="l-item" style="flex: 2;text-align: right">下注费：</div> <div class="r-item" style="flex: 1;text-align: right">' + t.curDownFee + '元</div> </div> <div class="p-line" style="display: flex"> <div class="l-item" style="flex: 2; font-size: 11px;text-align: right">通知费(夺宝自动打款微信钱包)：</div> <div class="r-item" style="flex: 1;text-align: right">1.00元</div> </div> <div class="p-line"  style="display: flex"> <div class="l-item" style="flex: 1; font-size: 20px">' + i + "</div> </div> </div>";
						t.promptMsg = "NOT_SUFFICIENT_FUNDS" == s ? l : i, t.isShowPrompt = !0
					}
				}))
			}
		},
...
default = {
		...
		data: function() {
			return {
				qrcodeurl: "/static/img/loading.gif"
			}
		},
		created: function() {
			var t = this;
			i.i(s.f)().then(function(e) {
				var i = (e.msg, e.code);
				200 == i ? t.qrcodeurl = s.u : window.location.href = "/"
			})
		},
		mounted: function() {
			this.$refs.listbox.addEventListener("touchmove", function(t) {
		...
		created: function() {
			...
			i.i(s.i)(e).then(function(e) {
				...
				var i = e.msg,
					...
					a = e.result;
				if (200 === s) {
					t.totalFee = a.totalfee, t.listData = a.list, t.recount = a.recount, t.level1 = t.recount.level1, t.level2 = t.recount.level2, t.level3 = t.recount.level3, t.level4 = t.recount.level4, t.level5 = t.recount.level5, t.totalCount = Number(t.level1.cnt) + Number(t.level2.cnt) + Number(t.level3.cnt) + Number(t.level4.cnt) + Number(t.level5.cnt);
			...
			timer: function(t) {
				...
				e.timersRes = window.setInterval(function() {
					var i = 0,
						...
						a = 0,
						n = 0;
					t > 0 && (i = Math.floor(t / 86400), s = Math.floor(t / 3600) - 24 * i, a = Math.floor(t / 60) - 24 * i * 60 - 60 * s, n = Math.floor(t) - 24 * i * 60 * 60 - 60 * s * 60 - 60 * a), a <= 9 && (a = "0" + a), n <= 9 && (n = "0" + n), e.minute = a, e.second = n, a <= 0 && n <= 0 && window.clearInterval(e.timersRes), t--
				}, 1e3)
			}
		}
	}
...
default = {
		...
		methods: {
			...
			rankChoose: function(t) {
				this.act = t, this.recommndRanking(t)
			}
		},
		mounted: function() {
			this.$refs.listbox.addEventListener("touchmove", function(t) {
...
default = {
		...
		methods: {
			query: function(t) {
				var e = this;
				"object" == !(void 0 === t ? "undefined" : a()(t)) && (t = {}), i.i(r.g)(t).then(function(t) {
					var i = t.msg,
						s = t.code,
						a = t.result;
					200 === s ? (a.page.list && a.page.list.length > 0 ? a.page.list.length < 19 && (e.noresults = !0, e.loadingtitle = "没有更多了") : (e.noresults = !0, e.loadingtitle = "没有更多了"), e.totalFee = a.page.totalFee, e.listData.push.apply(e.listData, a.page.list)) : console.log(i)
...
default = {
		...
		data: function() {
			return {
				curAct: "0",
				curIndex: "0",
				chooseFee: [11, 22, 50, 100, 200, 500,1000,2000,5000],
				balance: 0,
				actSubmitBtn: !1,
				isShowPrompt: !1,
				promptMsg: "加载中..."
		...
		methods: {
			selectedFee: function(t, e) {
				this.curAct = t, this.curIndex = e, this.actSubmitBtn = !0
			},
			submitTopup: function(t) {
				if (this.curAct <= 0) return false;
				location.href = '/index.php?m=BaJie&c=Recharge&a=payto&money=' + this.curAct + '&type=' + t;
			},
...
default = {
		...
		methods: {
			query: function(t) {
				var e = this;
				"object" == !(void 0 === t ? "undefined" : a()(t)) && (t = {}), i.i(n.k)(t).then(function(t) {
					var i = t.msg,
						s = t.code,
						a = t.result;
...
default = {
		...
		methods: {
			balanceCallFn: function(t) {
				...
				this.balance = e.toFixed(2), this.redPacket = i.toFixed(2)
			},
			query: function(t) {
				var e = this;
				"object" == !(void 0 === t ? "undefined" : a()(t)) && (t = {}), i.i(d.j)(t).then(function(t) {
					var i = t.msg,
						s = t.code,
						a = t.result;
					200 === s ? (a.page.list && a.page.list.length > 0 ? a.page.list.length < 19 && (e.noresults = !0, e.loadingtitle = "没有更多了") : (e.noresults = !0, e.loadingtitle = "没有更多了"), e.listData.push.apply(e.listData, a.page.list)) : console.log(i)
...
default = {
		...
		methods: {
			...
			affirmWithdraw: function() {
				...
				if (!(s >= 1 && s < 1e4)) return this.promptMsg = "金额超出提现范围，最小1元，最大10000元", this.isShowPrompt = !0, void(this.inputVal = "");
				if (this.balance < 1) return this.promptMsg = "帐户余额不足！", this.isShowPrompt = !0, void(this.inputVal = "");
				var a = 100 * this.balance * 100;
				if (a /= 1e6, console.log(a), a -= .01 * a, s > this.balance - a) return this.promptMsg = "金额超出提现范围,最大提现:" + Math.floor(this.balance - a) + "元,其中需要扣除(" + a.toFixed(2) + "手续费)", this.isShowPrompt = !0, void(this.inputVal = "");
				var n = {
					fee: s
				};
			...
			balanceCallFn: function(t) {
				...
				this.balance = e.toFixed(2), this.redPacket = i.toFixed(2);
				var s = t.macthcount;
				s >= 95 && (t.witharwcount += s - 95), this.withdrawCount = 5 - t.witharwcount
			}
		}
	}
}, function(t, e, i) {
...
default = {
		...
		methods: {
			query: function(t) {
				var e = this;
				"object" == !(void 0 === t ? "undefined" : a()(t)) && (t = {}), i.i(d.b)(t).then(function(t) {
					var i = t.msg,
						s = t.code,
						a = t.result;
...
default = {
		...
		methods: {
			...
			query: function(t) {
				var e = this;
				"object" == !(void 0 === t ? "undefined" : a()(t)) && (t = {}), i.i(d.c)(t).then(function(t) {
					var i = t.msg,
						s = t.code,
						a = t.result;
					200 === s ? (a.page.list && a.page.list.length > 0 ? a.page.list.length < 19 && (e.noresults = !0, e.loadingtitle = "没有更多了") : (e.noresults = !0, e.loadingtitle = "没有更多了"), e.withdraw = a.page.withdraw, e.topup = a.page.topup, e.listData.push.apply(e.listData, a.page.list)) : console.log(i)
	...
	t.exports = {
		render: function() {
			...
			return s("div", {
				...
				staticClass: "right-value"
			}, [1 == t.typeAct ? s("span", [t._v("单雷区")]) : t._e(), t._v(" "), 3 == t.typeAct ? s("span", [t._v("多雷区")]) : t._e()])]), t._v(" "), s("div", {
				staticClass: "line-item"
			}, [s("div", {
				staticClass: "left-title"
			}, [t._v("下注")]), t._v(" "), s("div", {
				...
				staticClass: "right-box"
			}, [t._v(" 3 倍")])]), t._v(" "), s("li", [s("div", {
				staticClass: "mid-box"
			}, [t._v("命中3位数")]), t._v(" "), s("div", {
				staticClass: "right-box"
			}, [t._v(" 4.5 倍")])]), t._v(" "), s("li", [s("div", {
				staticClass: "mid-box"
			}, [t._v("命中4位数")]), t._v(" "), s("div", {
				staticClass: "right-box"
			}, [t._v(" 8 倍")])]), t._v(" "), s("li", [s("div", {
				staticClass: "mid-box"
			}, [t._v("命中5位数")]), t._v(" "), s("div", {
				staticClass: "right-box"
			}, [t._v(" 24 倍")])])])]), t._v(" "), s("div", {
				staticClass: "cd-box"
				...
				staticClass: "right-box"
			}, [t._v(" 4 倍")])]), t._v(" "), s("li", [s("div", {
				staticClass: "left-box"
			}, [t._v("3位数")]), t._v(" "), s("div", {
				staticClass: "mid-box"
			}, [t._v("命中3位数")]), t._v(" "), s("div", {
				staticClass: "right-box"
			}, [t._v(" 12 倍")])]), t._v(" "), s("li", [s("div", {
				staticClass: "left-box"
			}, [t._v("4位数")]), t._v(" "), s("div", {
				staticClass: "mid-box"
			}, [t._v("命中4位数")]), t._v(" "), s("div", {
				staticClass: "right-box"
			}, [t._v(" 24 倍")])]), t._v(" "), s("li", [s("div", {
				staticClass: "left-box"
			}, [t._v("5位数")]), t._v(" "), s("div", {
				staticClass: "mid-box"
			}, [t._v("命中5位数")]), t._v(" "), s("div", {
				staticClass: "right-box"
			}, [t._v(" 52 倍")])])])]), t._v(" "), s("div", {
				staticClass: "cd-box"
	...
	t.exports = {
		render: function() {
			...
			}, [i("ul", t._l(t.selType, function(e) {
				return i("li", {
					class: {
						act: e.val == t.selAct
					},
	...
	t.exports = {
		render: function() {
			...
			}, [i("ul", t._l(t.chooseFee, function(e, s) {
				return i("li", [i("span", {
					staticClass: "comm_bg",
					class: {
						feeAct: e == t.curAct
			...
			}, [t._v("QQ支付（备用）")])]), t._v(" "), t._m(0), t._v(" "), i("v-prompt", {
				directives: [{
					name: "show",
					rawName: "v-show",
					value: t.isShowPrompt,
		...
		staticRenderFns: [function() {
			...
			return i("div", {
				staticClass: "desc"
			}, [i("ul", [i("li", [t._v("充值由第三方收付款平台提供服务,充值秒到账;")]), t._v(" "), i("li", [t._v("充值问题请进群联系管员理客服;")])])])
		}]
	}
}, function(t, e) {
	t.exports = {
	...
	t.exports = {
		render: function() {
			...
			}, [t._v("提现记录"), i("i")])], 1), t._v(" "), i("li", {
				staticClass: "comm_bg"
			}, [i("router-link", {
				attrs: {
					to: "/transfershistory"
				}
			}, [t._v("交易明细"), i("i")])], 1), t._v(" "), i("li", {
				staticClass: "comm_bg"
			}, [i("router-link", {
				attrs: {
					to: "/myqrcodeurl"
	...
	t.exports = {
		render: function() {
			...
			return i("div", {
				...
				staticClass: "count"
			}, [t._v(t._s(t.todayFee) + "元")]), i("i")])], 1), t._v(" "), i("li", {
				staticClass: "flex comm_bg"
			}, [i("router-link", {
				attrs: {
					to: "/myrecommend"
				...
				staticClass: "title"
			}, [t._v("一级下线(" + t._s(t.level1.cnt) + ")")]), i("div", {
				staticClass: "count"
			}, [t._v(t._s(t.level1.money) + "元")]), i("i")])], 1), t._v(" "), i("li", {
				staticClass: "flex comm_bg"
			}, [i("router-link", {
				attrs: {
					to: "/myrecommend"
				...
				staticClass: "title"
			}, [t._v("二级下线(" + t._s(t.level2.cnt) + ")")]), i("div", {
				staticClass: "count"
			}, [t._v(t._s(t.level2.money) + "元")]), i("i")])], 1), t._v(" "), i("li", {
				staticClass: "flex comm_bg"
			}, [i("router-link", {
				attrs: {
					to: "/myrecommend"
				...
				staticClass: "title"
			}, [t._v("三级下线(" + t._s(t.level3.cnt) + ")")]), i("div", {
				staticClass: "count"
			}, [t._v(t._s(t.level3.money) + "元")]), i("i")])], 1), t._v(" "), i("li", {
				staticClass: "flex comm_bg"
			}, [i("router-link", {
				attrs: {
					to: "/myrecommend"
				...
				staticClass: "title"
			}, [t._v("四级下线(" + t._s(t.level4.cnt) + ")")]), i("div", {
				staticClass: "count"
			}, [t._v(t._s(t.level4.money) + "元")]), i("i")])], 1), t._v(" "), i("li", {
				staticClass: "flex comm_bg"
			}, [i("router-link", {
				attrs: {
					to: "/myrecommend"
				...
				staticClass: "title"
			}, [t._v("五级下线(" + t._s(t.level5.cnt) + ")")]), i("div", {
				staticClass: "count"
			}, [t._v(t._s(t.level5.money) + "元")]), i("i")])], 1)])]), t._v(" "), i("v-loading", {
				directives: [{
					name: "show",
					rawName: "v-show",
					value: t.isShowLoading,
	...
	t.exports = {
		render: function() {
			...
			return i("div", {
				...
				}, [1 == e.inex || 4 == e.inex ? i("span", [t._v("-")]) : 2 == e.inex || 3 == e.inex ? i("span", [t._v("+")]) : t._e(), t._v(" " + t._s(e.balance) + "元")])])
			})), t._v(" "), i("loading", {
				attrs: {
					imgshow: !t.noresults,
					title: t.loadingtitle
	...
	t.exports = {
		...
		staticRenderFns: [function() {
			...
			return i("div", {
				...
				staticClass: "right-box"
			}, [t._v(" 4 倍")])]), t._v(" "), i("li", [i("div", {
				staticClass: "left-box"
			}, [t._v("3位数")]), t._v(" "), i("div", {
				staticClass: "mid-box"
			}, [t._v("命中3位数")]), t._v(" "), i("div", {
				staticClass: "right-box"
			}, [t._v(" 12 倍")])]), t._v(" "), i("li", [i("div", {
				staticClass: "left-box"
			}, [t._v("4位数")]), t._v(" "), i("div", {
				staticClass: "mid-box"
			}, [t._v("命中4位数")]), t._v(" "), i("div", {
				staticClass: "right-box"
			}, [t._v(" 24 倍")])]), t._v(" "), i("li", [i("div", {
				staticClass: "left-box"
			}, [t._v("5位数")]), t._v(" "), i("div", {
				staticClass: "mid-box"
			}, [t._v("命中5位数")]), t._v(" "), i("div", {
		...
		render: function() {
			...
			return i("div", {
				...
				return i("li", {
					...
					staticClass: "left-title"
				}, [1 == e.type ? i("span", [t._v("单雷区")]) : t._e(), t._v(" "), 3 == e.type ? i("span", [t._v("多雷区")]) : t._e()]), t._v(" "), i("div", {
					staticClass: "left-right"
				}, [1 == e.match_result ? i("span", {
					staticClass: "win"
				}, [t._v("赢+" + t._s(e.match_fee))]) : 0 == e.match_result ? i("span", {
					staticClass: "lost"
				}, [t._v(" 输 -" + t._s(e.total_fee))]) : i("span", {
					staticClass: "tie"
					...
					staticClass: "lis-value"
				}, [t._v(t._s(e.total_fee) + "元")])]), t._v(" "), i("div", {
					staticClass: "lis"
				}, [i("div", {
					staticClass: "lis-title"
					...
					staticClass: "lis-value"
				}, [t._v(t._s(e.poundage_fee) + "元")])]), t._v(" "), i("div", {
					staticClass: "lis"
				}, [i("div", {
					staticClass: "lis-title"
