...
class LogMoneysModel extends BaseModel {
    ...
    public function queryByPage(){
		...
		$endDate = I('endDate');
		$sql = "select l.*,u.userName,u.loginName from __PREFIX__log_moneys l left join __PREFIX__users u on l.targetType=0 and targetId=u.userId where l.dataFlag=1 ";
		if($targetType!=-1){
		...
		$page = $this->pageQuery($sql,(int)I('p'),20);
		if(!empty($page['root'])){
