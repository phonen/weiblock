/**
 * Created by youngyang on 2017/5/23.
 */
document.write('<div id="modal-container" class="modal fade"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">提示信息</h4></div><div class="modal-body"><p class="msg" style="font-size:14px;"></p></div><div class="modal-footer"><button type="button"  style="padding:8px 26px;border-color:rgb(0,122,255);background-color:rgb(0,122,255);"  class="alert-jump btn btn-primary" data-dismiss="modal" data-url="">确定</button></div></div></div></div>');
